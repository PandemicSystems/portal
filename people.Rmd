...
Tess Stephens is a user experience designer at Talus Analytics focused on creating visuals that allow data to be thoughtfully investigated. Her work is informed by her interest in systems design, her background in writing and editing, and her commitment to clarity and functionality. 
...
<a class="toggle-text-button">Read more</a>
<div class="toggle-text" style="display: none;">
Stott spent a year at the CDC for an ORISE fellowship with the influenza division prior to starting their PhD in bioinformatics at UGA in 2021. Stott is treasurer for the Bioinformatics Graduate Student Association at the University of Georgia and an editor for the Athens Science Observer in Athens, GA. 
</div>
<a href="#" class="read-less" style="display:none;">Read less</a>
</div>
</div>
