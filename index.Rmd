...
## **Heterogeneous Model Integration for Infectious Disease Intelligence (&nbsp;HeMI&nbsp;:&nbsp;IDI&nbsp;)** {.lead}
...
is a multi-disciplinary, multi-institutional project seeking to apply the engineering System-of-Systems (SoS) concept to the grand challenge of integrating models across disciplines and scales. This project introduces a new paradigm (SoS) for infectious disease modeling. 
