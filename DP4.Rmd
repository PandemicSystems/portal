...
```{r fig1, echo=FALSE, out.width='600px', out.extra='style="float:left; padding:10px"', fig.cap=''}
knitr::include_graphics("images/DP4_model.png")
```
...
```{r fig2, echo=FALSE, out.width='400px', out.extra='style="float:left; padding:10px"', fig.cap=''}
knitr::include_graphics("images/DP4_Policy_1.png")
```
...
Initial conditions are: $S_c = 0.4999$, $I_c = 0.0001$, $R_c=0$, $S_n=0.4999$, $I_n=0.0001$,$R_n=0$. 

Parameters of $\phi_c(P)$ are: $L=1$,$k=10$,and $p_0 =0.5$. 
...
```{r fig3, echo=FALSE, out.width='350px', out.extra='style="float:left; padding:10px"', fig.cap=''}
knitr::include_graphics("images/DP4_Policy_2.png")
```
